 ...
 */
package org.wso2.carbon.das.mediationflowstatistics.data.publisher.internal;
...
import org.wso2.carbon.das.mediationflowstatistics.data.publisher.observer.DASMediationFlowStatisticsObserver;
import org.wso2.carbon.das.mediationflowstatistics.data.publisher.services.DASMediationStatsPublisherAdmin;
import org.wso2.carbon.das.mediationflowstatistics.data.publisher.util.CommonConstants;
...
/**
 * @scr.component name="org.wso2.carbon.das.mediationflowstatistics.data.publisher" immediate="true"
 ...
 * @scr.reference name="new.mediation.statistics"
 * interface="org.wso2.carbon.mediation.flow.statistics.service.MediationStatisticsService"
...
public class MediationStatisticsComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        if(true){
            ...
            StatisticsStore mediationStatisticsStore = mediationStatisticsService.getTenantStatisticsStore();
            int tenantId = mediationStatisticsService.getTenantId();

            if(mediationStatisticsStore!= null){
                DASMediationFlowStatisticsObserver observer = new DASMediationFlowStatisticsObserver();
    ...
    protected void setMediationStatisticsService(MediationStatisticsService mediationStatisticsService) {
        ...
        if (activated && mediationStatisticsService != null) {
            StatisticsStore mediationStatisticsStore =
                    mediationStatisticsService.getTenantStatisticsStore();
            DASMediationFlowStatisticsObserver observer = new DASMediationFlowStatisticsObserver();
            mediationStatisticsStore.registerObserver(observer);
